...
<nav class="navbar sticky  shadow-lg" id="nav" style="background-color: #1f2937; ">

        <div class=" col-sm-8 m-auto" style="color: #27b4f5;">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a href="login.php" class="btn" style="text-decoration:none; color:rgb(162, 92, 228) ">Admin</a>
        </li></ul></div>
        <!-- <div class="col-lg">
             <h4>Contact Us</h4>
